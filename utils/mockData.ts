...
// Drink types with their properties
const drinkTypes = [
  { type: 'beer', name: 'Beer', amount: 330, unit: 'mL', emoji: '🍺' },
  { type: 'beer', name: 'IPA', amount: 355, unit: 'mL', emoji: '🍺' },
  { type: 'wine', name: 'Red Wine', amount: 5, unit: 'oz', emoji: '🍷' },
  { type: 'wine', name: 'White Wine', amount: 5, unit: 'oz', emoji: '🍷' },
  { type: 'wine', name: 'Rosé', amount: 5, unit: 'oz', emoji: '🍷' },
  { type: 'cocktail', name: 'Margarita', amount: 200, unit: 'mL', emoji: '🍹' },
  { type: 'cocktail', name: 'Mojito', amount: 250, unit: 'mL', emoji: '🍹' },
  { type: 'cocktail', name: 'Martini', amount: 150, unit: 'mL', emoji: '🍸' },
  { type: 'cocktail', name: 'Negroni', amount: 200, unit: 'mL', emoji: '🍸' },
  { type: 'cocktail', name: 'Old Fashioned', amount: 180, unit: 'mL', emoji: '🥃' },
  { type: 'custom', name: 'Whiskey', amount: 2, unit: 'oz', emoji: '🥃' },
  { type: 'custom', name: 'Vodka', amount: 2, unit: 'oz', emoji: '🥃' },
  { type: 'custom', name: 'Gin', amount: 2, unit: 'oz', emoji: '🥃' },
];

// Generate random drinks for the past 40 days
const generateDrinksForPastDays = (days: number = 40): { [date: string]: DrinkLog[] } => {
...
const generateHealthScoresFromDrinks = (drinks: { [date: string]: DrinkLog[] }): { [date: string]: number } => {
...
// Get last drink date
const getLastDrinkDate = (drinks: { [date: string]: DrinkLog[] }): string | null => {
...
export const formatRelativeTime = (timestamp: string): string => {
  ...
  if (diffInDays < 7) return `${diffInDays} ${getTranslation('daysAgo', language)}`;
